...
class Exp:
    ...
    def checkToyModel(x0,T):
        toySystem=SimpleSystem.getSimpleSystem(x0,T)
        ...
        Exp.vizLossCost(trueLosses,trueCosts,expLosses,expCosts)
        ...
        Exp.vizSimpleLossCost(lossesList,costsList)
    ...
    def checkOffloading(x0,T):
        ...
        Exp.vizModelChoices(optChoices)
        ...
        Exp.vizStats(labels,perCosts,controlCosts,rewards)
    ...
    def checkOffloadingVaryingAB(x0,T):
        ...
        Exp.vizParetoOpti(ctrlCosts,perCosts)
    ...
    def vizStats(labels,perCosts,controlCosts,rewards,th0=0,th1=1,fname="simple_system_"):
        ...
        for (label,perCost,controlCost) in zip(labels,perCosts,controlCosts):
            ...
            plt.scatter(perCost,controlCost,s=500,marker='o',alpha=0.1)
            plt.text(meanPerCost+1,meanCtrlCost+1,label,horizontalalignment='left',color='k')
